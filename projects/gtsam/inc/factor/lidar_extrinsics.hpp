...
class LidarExtrinsicsFactor
 ...
 public:
  ...
  gtsam::NonlinearFactor::shared_ptr clone() const override {
    return gtsam::NonlinearFactor::shared_ptr(new LidarExtrinsicsFactor(*this));
  }

  gtsam::Vector evaluateError(const gtsam::Pose3& X_i, const gtsam::Pose3& X_j,
                              const gtsam::Pose3& T_BL, gtsam::OptionalMatrixType H_Xi,
